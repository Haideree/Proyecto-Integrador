...
public class Registroprod extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Titulo.setText("Registro de Productor");
        ...
        Text_numdocprod.setBackground(new java.awt.Color(225, 237, 227));
        Text_numdocprod.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(187, 213, 191)));
        Text_numdocprod.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Text_numdocprodActionPerformed(evt);
            }
        });
        fondo.add(Text_numdocprod, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 310, 20));
        ...
        Text_nombreprod.setBackground(new java.awt.Color(225, 237, 227));
        Text_nombreprod.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(187, 213, 191)));
        Text_nombreprod.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Text_nombreprodActionPerformed(evt);
            }
        });
        fondo.add(Text_nombreprod, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, 310, 20));

        Text_telefonoprod.setBackground(new java.awt.Color(225, 237, 227));
        Text_telefonoprod.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(187, 213, 191)));
        Text_telefonoprod.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Text_telefonoprodActionPerformed(evt);
            }
        });
        fondo.add(Text_telefonoprod, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 310, 20));
        ...
        Text_correoprod.setBackground(new java.awt.Color(225, 237, 227));
        Text_correoprod.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(187, 213, 191)));
        Text_correoprod.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Text_correoprodActionPerformed(evt);
            }
        });
        fondo.add(Text_correoprod, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 240, 310, 20));
    ...
    private void Text_correoprodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Text_correoprodActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Text_correoprodActionPerformed
