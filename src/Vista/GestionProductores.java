 ...
 * @author Usuario
 */
public class GestionProductores extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GestionProductores.class.getName());

    /**
     * Creates new form GestionProductores
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestión de Productores");
        fondo.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 730, -1));
        ...
        TablaProd.setBackground(new java.awt.Color(224, 224, 224));
        TablaProd.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(55, 165, 87)));
        TablaProd.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        TablaProd.setForeground(new java.awt.Color(55, 165, 87));
        TablaProd.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "N° Documento", "Nombre", "Telefono", "Correo", "Solicitud", "Contraseña"
            }
        ));
        TablaProd.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_NEXT_COLUMN);
        TablaProd.setColumnSelectionAllowed(false);
    ...
    public JTable getTablaProd() {return TablaProd;}
    ...
    java.awt.EventQueue.invokeLater(() -> {
        GestionProductores vista = new GestionProductores();
        new Controlador.ControladorGestionProductores(vista); // 🔹 Conexión vista-controlador
